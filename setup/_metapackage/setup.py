...
setuptools.setup(
    ...
    install_requires=[
        ...
        'odoo14-addon-ssi_hr_holiday_documenso_signing',
        'odoo14-addon-ssi_hr_holiday_operating_unit',
        'odoo14-addon-ssi_hr_leave_allocation_request_batch',
        'odoo14-addon-ssi_hr_leave_allocation_request_batch_documenso_signing',
        'odoo14-addon-ssi_hr_leave_allocation_request_batch_operating_unit',
        'odoo14-addon-ssi_hr_leave_request_batch',
        'odoo14-addon-ssi_hr_leave_request_batch_documenso_signing',
        'odoo14-addon-ssi_hr_leave_request_batch_operating_unit',
        'odoo14-addon-ssi_hr_overtime',
        'odoo14-addon-ssi_hr_overtime_account',
        'odoo14-addon-ssi_hr_overtime_batch',
        'odoo14-addon-ssi_hr_overtime_batch_operating_unit',
        'odoo14-addon-ssi_hr_overtime_documenso_signing',
        'odoo14-addon-ssi_hr_overtime_operating_unit',
