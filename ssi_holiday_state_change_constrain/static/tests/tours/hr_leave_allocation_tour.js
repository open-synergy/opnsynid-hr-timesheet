odoo.define("ssi_holiday_state_change_constrain.hr_leave_allocation_tour", function (
    require
) {
    "use strict";
    ...
    // (open menu, click New) up to the point of change, asserts
    // the Status Checks tab this module adds, then stops — it
    // does not continue into Save/Confirm
    // (odoo-development-ui-test skill, scope-and-boundaries.md
    // §3, arketipe E1/E2a).
    // ═══════════════════════════════════════════════════════════
    tour.register(
        ...
        [
            // ── Flow 1 (base) — Open the Human Resource >
            // Timesheets > Leave Allocations menu.
            ...
            // ── Delta — Modified Flow: the Status Checks tab,
            // added by this module's mixin.status_check, is shown
            // on the form.
            {
            ...
            },
            {
                ...
                run: function () {
                    ...
                    // not continue into Save/Confirm.
                },
            },
        ]
    );
