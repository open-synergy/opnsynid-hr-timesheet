odoo.define("ssi_hr_leave_request_batch.hr_leave_request_batch_tour", function (
    require
) {
    "use strict";
    ...
    // Shared opening steps: Human Resource > Timesheets > Leave Request
    // Batch. "Timesheets" (level 2, section) has several children
    // (Timesheets, Leaves, Leave Allocations, Overtimes, Leave Request
    // Batch, ...) so it is clickable as a dropdown-toggle; "Leave Request
    // Batch" (level 3) is a leaf, also clickable.
    function openLeaveRequestBatchMenuSteps() {
        return [
            ...
            {
                content: "Open the Leave Request Batch menu item",
                trigger:
                    ".o_menu_sections " +
                    '[data-menu-xmlid="ssi_hr_leave_request_batch.menu_hr_leave_request_batch"]',
            },
            {
                // Gate: wait for the TARGET action, not just any list view —
                // the app landing action is also a .o_list_view.
                content: "Leave Request Batch list is displayed",
                trigger:
                    ".o_control_panel " +
                    ".breadcrumb-item.active:contains(Leave Request Batch)",
    ...
    tour.register(
        ...
        [].concat(openLeaveRequestBatchMenuSteps(), [
            ...
            // ── Flow 3 — Fill in Type, Employee(s), Date Start, Date End.
            {
                content: "Select the Type",
                trigger: ".o_field_many2one[name='type_id'] input",
                extra_trigger: ".o_form_view.o_form_editable",
                run: "text TOUR-LRBATCH-TYPE-CREATE",
            },
            {
                content: "Pick the Type from the dropdown",
                trigger:
                    ".ui-autocomplete .ui-menu-item a:contains(" +
                    "TOUR-LRBATCH-TYPE-CREATE)",
                in_modal: false,
            },
            // The "Employee" notebook page is inserted (together with
            // "Leave Request") immediately before the base "Note" page,
            // which makes it the FIRST page in the resulting notebook —
            // i.e. the tab active by default when the form opens. No
            // "click the tab" step is needed before interacting with
            // `employee_ids` (odoo-development-ui-test skill: only
            // non-default tabs need an explicit click step; verified
            // against views/hr_leave_request_batch_view.xml).
            //
            ...
            },
            {
                ...
                run: "text TOUR-LRBATCH-EMP-CREATE",
            },
            {
            ...
            },
            {
                ...
                trigger:
                    ".o_data_row:contains(TOUR-LRBATCH-EMP-CREATE) " +
                    ".o_data_cell:first",
            },
            {
                // Date_start/date_end come from `mixin.date_duration`
                // (fields.Date, not Datetime) — the widget takes a plain
            ...
            // ── Post-Condition — a new leave request batch record is
            // created in Draft.
            {
    ...
    tour.register(
        ...
        [].concat(
            openLeaveRequestBatchMenuSteps(),
            openRecordStep("TOUR-LRBATCH-TYPE-EDIT"),
            [
                {
    ...
    tour.register(
        ...
        [].concat(
            openLeaveRequestBatchMenuSteps(),
            openRecordStep("TOUR-LRBATCH-TYPE-DELETE"),
            [
                ...
                {
                    content:
                        "Click the Leave Request Batch breadcrumb to return " +
                        "to the list",
                    trigger:
                ...
                {
                    content:
                        "Deleted leave request batch no longer appears in " +
                        "the list",
                    trigger:
                        ".o_list_view:not(:has(.o_data_row:contains(" +
                        "TOUR-LRBATCH-TYPE-DELETE)))",
                    run: function () {
                        // Assertion only; do not trigger the default click
                        // action.
                    },
    ...
    tour.register(
        ...
        [].concat(
            openLeaveRequestBatchMenuSteps(),
            openRecordStep("TOUR-LRBATCH-TYPE-CONFIRM"),
            [
                ...
                // available). This fixture's Employee(s) is empty, so no
                // hr.leave document is created (see the "If Employee(s)
                // is empty" branch of this IK's Post-Condition) — that
                // branch, and the hr.leave documents it produces, are out
                // of scope here (see ssi_hr_holiday's own hr.leave tour
                // set).
                {
    ...
    tour.register(
        ...
        [].concat(
            openLeaveRequestBatchMenuSteps(),
            openRecordStep("TOUR-LRBATCH-TYPE-APPROVE"),
            [
    ...
    tour.register(
        ...
        [].concat(
            openLeaveRequestBatchMenuSteps(),
            openRecordStep("TOUR-LRBATCH-TYPE-REJECT"),
            [
    ...
    tour.register(
        ...
        [].concat(
            openLeaveRequestBatchMenuSteps(),
            openRecordStep("TOUR-LRBATCH-TYPE-CANCEL"),
            [
                ...
                },
                {
                    ...
                    trigger:
                        ...
                        ".o_radio_item:contains(TOUR-LRBATCH-CANCEL-REASON) input",
                },
    ...
    tour.register(
        ...
        [].concat(
            openLeaveRequestBatchMenuSteps(),
            openRecordStep("TOUR-LRBATCH-TYPE-RESTART"),
            [
    ...
    tour.register(
        ...
        [].concat(
            openLeaveRequestBatchMenuSteps(),
            openRecordStep("TOUR-LRBATCH-TYPE-RESETNUM"),
            [
    ...
    tour.register(
        ...
        [].concat(
            openLeaveRequestBatchMenuSteps(),
            openRecordStep("TOUR-LRBATCH-TYPE-REAPPROVAL"),
            [
