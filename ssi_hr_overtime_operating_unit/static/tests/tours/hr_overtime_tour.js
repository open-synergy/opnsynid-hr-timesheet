odoo.define("ssi_hr_overtime_operating_unit.hr_overtime_tour", function (require) {
    "use strict";

    var tour = require("web_tour.tour");

    // IK: docs/hr_overtime/01-create.md (E1 delta -- Additional Fields)
    // Navigation (open menu -> New) is retraced from the base IK
    // ssi_hr_overtime/docs/hr_overtime/01-create.md Flow steps 1-2 -- see
